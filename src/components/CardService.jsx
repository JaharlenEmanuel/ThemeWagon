...
export default function CardService() {
    ...
    return (
        <>
            ...
            <section className=" bg-linear-to-bl from-blue-50 to-pink-50 w-screen">
                <div className="w-screen bg-linear-to-bl from-pink-100 to-fuchsia-100 ">
                    <div className="text-center bg-linear-to-bl from-pink-100 to-fuchsia-100">
